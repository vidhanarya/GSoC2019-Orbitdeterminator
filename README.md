...
A general U.K. format observation is

`970120120181707191411226783000001119161509-1302496 1  50598270500667+6 +8   190R`

here each column has defined meaning, similarly, a general I.O.D. format observation is

`23794 96 010A   2701 G 20040506012614270 17 25 1100114-184298 38 I+020 10 01189`
...
**Install Scripts**: I built install scripts for macOS and Linux based systems, which automatically clones and install all the dependencies of the program. It also gives the user the ability to use the program with *orbitdeterminator* command such that 

`orbitdeterminator -f arg1 arg2 ...`
